...
CTO SeungBae Lee (이승배), the guy who has a long history of developer always tried to be a friendly with every developer. He always pushed us to call him by his name without adding CTOnim (CTO님), which is equal to calling him a boss in English. He even got angry few times when I called him like that by mistake. He was always open for discussion and gives really good arguments. He doesn't like round talks, always tries to talk straight to problem and think about its solutions. He has that ability of recognizing a main point of the conversation just by hearing few words from the conversation. Reads a lot of books and follows the recent trends all the time. He even had a daily three useful links for us, where every day he sends us three links related to IT news and summarizes them in a few lines. So you can just read his summaries about the news and if you are interested more, you could open it and read details.
